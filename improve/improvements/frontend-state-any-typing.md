...
type: Improvement
description: "The frontend AgentState declares resources and logs as any[], erasing type safety across the whole cross-process state contract even though Resource is defined in the same file and a Log shape exists on the backend"
...
[1] [src/lib/types.ts:23](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/src/lib/types.ts#L23) — `Resource[]`
[2] [src/lib/types.ts:24](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/src/lib/types.ts#L24) — `Log[]`
[3] [src/lib/types.ts:14](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/src/lib/types.ts#L14) — `Log`
