...
failure: silent  # a mismatched field just doesn't render — no type error crosses the process boundary
cites:
...
`logs` drives the `Progress` step list (one of the seven feature components rostered in
[the design-system convention](/brain/rules/design-system-convention.md)) via
...
[1] [src/lib/types.ts:19](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/src/lib/types.ts#L19) — `AgentState`
[2] [src/lib/types.ts:21](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/src/lib/types.ts#L21) — `research_question`
[3] [src/lib/types.ts:22](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/src/lib/types.ts#L22) — `report`
[4] [src/lib/types.ts:23](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/src/lib/types.ts#L23) — `resources`
[5] [src/lib/types.ts:24](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/src/lib/types.ts#L24) — `logs`
[6] [src/lib/types.ts:25](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/src/lib/types.ts#L25) — `citations`
[7] [agents/python/src/lib/state.py:41](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/agents/python/src/lib/state.py#L41) — `AgentState`
[8] [agents/python/src/lib/state.py:48](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/agents/python/src/lib/state.py#L48) — `research_question`
[9] [agents/python/src/lib/state.py:51](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/agents/python/src/lib/state.py#L51) — `logs`
[10] [agents/python/src/lib/state.py:52](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/agents/python/src/lib/state.py#L52) — `citations`
[11] [agents/typescript/src/state.ts:19](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/agents/typescript/src/state.ts#L19) — `AgentStateAnnotation`
[12] [agents/typescript/src/state.ts:21](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/agents/typescript/src/state.ts#L21) — `research_question`
[13] [agents/typescript/src/state.ts:24](https://github.com/gallirohik/research-canvas/blob/c31971e8a2b5a4992aee13917704e47e492369d7/agents/typescript/src/state.ts#L24) — `logs`
